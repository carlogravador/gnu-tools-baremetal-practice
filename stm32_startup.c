...
void Reset_Handler(void)
{
    ...
    uint8_t* pDst = (uint8_t*)&_sdata;  //start of sram
    uint8_t* pSrc = (uint8_t*)&_etext;  //end of flash = start of data in flash
    ...
    // call init function of std. library if you are using one
